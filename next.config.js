module.exports = {
  ...
  env: {
    ...
    INFURA_PROJECT_ID: process.env.INFURA_PROJECT_ID || '26d609e06df646d886d55d2b25523e9d',
    ...
    UAUTH_POSTLOGOUT_REDIRECT_URI: process.env.UAUTH_POSTLOGOUT_REDIRECT_URI,
  },
}
